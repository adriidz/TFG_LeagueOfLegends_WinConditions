...
RAW_ROOT_DEFAULT = "data/raw/raw"
INDEX_CSV_DEFAULT = "data/clean/raw_index.csv"
STATE_DB_DEFAULT = "data/clean/raw_state.sqlite"
...
def state_set(conn, match_id: str, routing_region: str, status: str, last_error: str = None, commit: bool = True):
...
def raw_files_exist(raw_root: str, routing_region: str, match_id: str) -> bool:
    """Comprueba si match.json y timeline.json existen para una partida."""
