...
```bash
python train_jungle_presence_model.py   --input-path data/clean/model_input_jungle.parquet   --output-dir data/clean/ml/jungle_presence_v1   --class-weight-balanced
```
